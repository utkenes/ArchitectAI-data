...
def main():
    ...
    print("\n========================================================")
    print("     ArchitectAI V1.1.1 Post-Build Mandatory Audit      ")
    print("========================================================")
    ...
    print(f"10. Exact Duplicate Content:         {stats_data.get('exact_duplicates_filtered')}")
    print(f"11. Near Duplicates:                 {stats_data.get('near_duplicates_filtered')}")
    ...
    print(f"15. Quarantine Breakdown:            {stats_data.get('quarantine_reason_breakdown')}")
